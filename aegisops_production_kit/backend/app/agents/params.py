    ...
    "gcp.vm": [
        ...
        ParamSpec("allowed_cidr", "Allowed source IP/CIDR", required=True,
                  help="your public IP (e.g. 203.0.113.7) to open SSH for it, or 'none' to keep "
                       "remote access closed"),
        ParamSpec("network", "VPC network", default="default",
                  help="an existing gcp.vpc is offered automatically when known (MS-12)"),
        ParamSpec("enable_shielded", "Shielded VM", kind="bool", default=False,
                  help="secure boot + vTPM + integrity monitoring (B2: off for existing)"),
        ParamSpec("enable_oslogin", "OS Login", kind="bool", default=False,
                  help="IAM-governed SSH; the generated key is unused while enabled"),
        ParamSpec("spot", "Spot/preemptible", kind="bool", default=False,
                  help="may be stopped by GCP at any time; no automatic restart"),
        ParamSpec("project", "GCP project id", help="defaults to the configured project"),
